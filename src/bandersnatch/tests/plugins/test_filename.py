...
def test_plugin_compiles_patterns() -> None:
    mock_config(_MULTI_PLATFORM_CONFIG)
...
def test_exclude_platform() -> None:
    """
...
def test_exclude_linux_platform_tags() -> None:
    """
    When excluding linux, ensure PEP 600 manylinux tags are excluded too.
    """
    mock_config(_LINUX_ONLY_PEP_600_CONFIG)
